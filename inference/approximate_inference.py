...
class ApproximateInferenceEngine(object):
    ...
    def perform_inference(self, query_variable, evidence_variables, number_of_samples):
        ...
        for i in xrange(number_of_samples):
            sample_assignments = self.generate_sample()
    ...
    def generate_sample(self):
        ...
        The assignment respects the given conditional probabilities in the network.
